...
int main()
{
	...
	//编译Shaders
	Shader simpleDepthShader("shaders/5_advanced_lighting/3_2_1_point_shadows/point_shadows_depth.vs",
		"shaders/5_advanced_lighting/3_2_1_point_shadows/point_shadows_depth.fs",
		"shaders/5_advanced_lighting/3_2_1_point_shadows/point_shadows_depth.gs");
...
void processInput(GLFWwindow* window)
{
	...
	if (glfwGetKey(window, GLFW_KEY_SPACE) == GLFW_RELEASE && shadowKeyPressed)
	{
		shadows = !shadows;
