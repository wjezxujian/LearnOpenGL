...
int main()
{
	...
	Shader lightingShader("shaders/shader_lightcasters.vs", "shaders/shader_lightcasters.fs");
	lightingShader.use();
	...
	//glUniform3f(glGetUniformLocation(lightingShader.getShaderID(), "light.direction"), direction.x, direction.y, direction.z);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(glGetUniformLocation(lightingShader.getShaderID(), "light.position"), camera.Position.x, camera.Position.y, camera.Position.z);
		glUniform3f(glGetUniformLocation(lightingShader.getShaderID(), "light.direction"), camera.Front.x, camera.Front.y, camera.Front.z);
