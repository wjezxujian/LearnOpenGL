...
int main()
{
	...
	//编译Shaders
	Shader shader("shaders/5_advanced_lighting/6_hdr/lighting.vs", "shaders/5_advanced_lighting/6_hdr/lighting.fs");
	shader.use();
	shader.setUniformValue("diffuseTexture", 0);
	
	Shader hdrShader("shaders/5_advanced_lighting/6_hdr/hdr.vs", "shaders/5_advanced_lighting/6_hdr/hdr.fs");
	hdrShader.use();
