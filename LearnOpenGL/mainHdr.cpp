...
int main()
{
	...
	//编译Shaders
	Shader shader("shaders/5_advanced_lighting/6_lighting/lighting.vs", "shaders/5_advanced_lighting/6_lighting/lighting.fs");
	shader.use();
	shader.setUniformValue("diffuseTexture", 0);
	
	Shader hdrShader("shaders/5_advanced_lighting/6_lighting/hdr.vs", "shaders/5_advanced_lighting/6_lighting/hdr.fs");
	hdrShader.use();
